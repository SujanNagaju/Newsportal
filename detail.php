									...
									<div class="col-12">
										<div class="row">
											<div class="col-12">
												...
												<br>
												<small><em><?php echo $comment['email']; ?></em></small>
											</div>
											<div class="col-12 comment ">
												<?php echo $comment['comment']; ?>
											</div>
											<div class="col-12">
												<small><i class = "zmdi zmdi-time"></i><?php echo date('j M Y  \a\t H:i', strtotime($article['created_at'])); ?>
												<a href = "#" data-toggle="modal" data-target="#reportModal" data-id="<?php echo $comment['id']; ?>">Report this comment</a></small>
											</div>
										</div>
									</div>
									<?php endwhile; ?>
				...
				<div class="col-lg-5 col-md ml-auto">
					<div class="row">
						...
						<?php while($similar = db_fetch_assoc($result)): ?>
							...
							<div class="col-lg-4 col-md-5">
								<div style="background-image: url('<?php echo url('images/'.$similar['featured_image']); ?>')" class="article-thumbnail border"></div>
							</div>
							<?php endif; ?>
					...
					<?php endif; ?>
						...
						<?php while($recommended = db_fetch_assoc($result)): ?>
							...
							<div class="col-lg-4 col-md-5">
								<div style="background-image: url('<?php echo url('images/'.$recommended['featured_image']); ?>')" class="article-thumbnail border"></div>
							</div>
							<?php endif; ?>
									<div class="col-lg-8 col-md-7">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Report a comment </h5>
