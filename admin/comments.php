									...
									<?php while($comment = db_fetch_assoc($result)): ?>
										<tr>
											...
											<td>
												...
												<a href="<?php echo url('admin/comment-edit.php?s='.$comment['id'].'&status = inactive'); ?>" data-toggle="tooltip" title="disable this comment." class="mr-2"><i class="zmdi zmdi-close"></i></a>
											<?php else: ?>
												<a href="<?php echo url('admin/comment-edit.php?s='.$comment['id'].'&status = active'); ?>" data-toggle="tooltip" title="Enable this comment." class="mr-2"><i class="zmdi zmdi-check"></i></a>
											<?php endif; ?>
